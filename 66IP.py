...
url_ip = 'http://www.66ip.cn/index.html'
...
def scrawl_jiangxianli_ip(num):
    ...
    #etree解析不出来？？？？
    # content = bytes(bytearray(response.text, encoding='utf-8'))
    # tree = etree.HTML(content)
    # tr_list = tree.xpath('/html/body/div[4]/div[1]/div[2]/div[1]/table/tbody/tr')
    # print(tr_list)
    # for tr in tr_list:
